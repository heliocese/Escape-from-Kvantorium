...
students = {
    'Никита': ['1', 'Успевает делать все задания в Лицее. '
                    'Как именно это ему это удаётся никто не знает. Возможно освоил знания тайм менеджмента, ну, '
                    'или же не спит ночами'],
    'Ангелина': ['1', 'На втором занятии уже всех знала по именам. Коммуникабельная, в общем.  Однажды '
                      'смогла договориться '
                      'с муравьями, правда, не понятно, что больше помогло в переговорах: дихлофос или ее красноречие'],
    'Коля': ['1', 'Обычный мальчик, живущий самой обычной жизнью'],
    'Настя': ['1', 'Испугалась, что Ангелина на самом деле обиделась, когда она с ней не поздоровалась'],
    'Алиса': ['1', 'При нашей просьбе написать шуточное описание, она написала резюме:        '
    ...
    'Илья': ['1', 'Самый маленький член группы'],
    'Максим': ['1', 'Он не смог ничего придумать, написав: "Мне лень - подойдёт как описание?"']
}

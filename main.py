...
def main_menu():  # главное меню
    ...
    play_btn = Button(WIDTH // 2, 125, button_image, button_image1, 'Играть', 4)
    char_sel_btn = Button(WIDTH // 2, 225, button_image, button_image1, 'Выбор персонажа', 4)
    statistics_btn = Button(WIDTH // 2, 325, button_image, button_image1, 'Статистика', 4)
    settings_btn = Button(WIDTH // 2, 425, button_image, button_image1, 'Настройки', 4)
    exit_btn = Button(WIDTH // 2, 525, button_image, button_image1, 'Выход', 4)
...
def levels():
    ...
    img_1_ = load_image('1_.png')
    img_2_ = load_image('2_.png')
    img_3_ = load_image('3_.png')
    img_4_ = load_image('4_.png')
    img_5_ = load_image('5_.png')
    img_6_ = load_image('6_.png')
    img_7_ = load_image('7_.png')
    img_8_ = load_image('8_.png')
    img_9_ = load_image('9_.png')
    ...
    btn_1 = Button(100, 150, img_1, img_1_)
    btn_2 = Button(200, 150, img_2, img_2_)
    btn_3 = Button(300, 150, img_3, img_3_)
    btn_4 = Button(400, 150, img_4, img_4_)
    btn_5 = Button(500, 150, img_5, img_5_)
    btn_6 = Button(100, 250, img_6, img_6_)
    btn_7 = Button(200, 250, img_7, img_7_)
    btn_8 = Button(300, 250, img_8, img_8_)
    btn_9 = Button(400, 250, img_9, img_9_)
